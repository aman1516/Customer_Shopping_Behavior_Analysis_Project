...
SELECT category, (SUM(purchase_amount),2) AS highest_revenue
FROM customer
GROUP BY category
...
SELECT discount_applied,
	   (SUM(purchase_amount),2) AS total_revenue,
...
SELECT gender,
	   (SUM(purchase_amount),2) AS highest_revenue
FROM customer
GROUP BY gender
ORDER BY highest_revenue DESC
...
SELECT item_purchased,
	   (AVG(review_rating),2) AS Avg_ratings
FROM customer
...
SELECT 
	...
	(AVG(purchase_amount),2)  AS avg_purchase,
	(SUM(purchase_amount),2) AS revenue
FROM customer
...
SELECT 
	...
	(AVG(purchase_amount),2) as avg_revenue,
	(SUM(purchase_amount),2) as total_revenue
FROM customer
